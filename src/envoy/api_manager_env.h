...
class Env : public google::api_manager::ApiManagerEnvInterface, public Logger::Loggable<Logger::Id::http> {
 private:
 ...
 public:
  ...
  virtual void
  RunHTTPRequest(std::unique_ptr<google::api_manager::HTTPRequest> request) override;
};
